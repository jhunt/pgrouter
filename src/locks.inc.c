...
{
	pgr_logf(stderr, LOG_DEBUG, "[" SUBSYS "] acquiring %s/%d read lock %p", what, idx, l);
...
{
	pgr_logf(stderr, LOG_DEBUG, "[" SUBSYS "] acquiring %s/%d write lock %p", what, idx, l);
...
{
	pgr_logf(stderr, LOG_DEBUG, "[" SUBSYS "] releasing %s/%d lock %p", what, idx, l);
